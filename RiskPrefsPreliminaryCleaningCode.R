...
input_data_pilot <- paste0(base_wd, "/Dropbox/WIAGL_DATA/RiskPreferences/Pilot/")
input_data_raw <- paste0(base_wd, "/Dropbox/WIAGL_DATA/RiskPreferences/Pilot/Raw/")
input_data_pagetimes <- paste0(base_wd, "/Dropbox/WIAGL_DATA/RiskPreferences/Pilot/PageTimes/")
input_data_assignment_tables <- paste0(base_wd, "/Dropbox/WIAGL_DATA/RiskPreferences/Pilot/Manual_Qualification_Criteria/")
